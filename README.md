...
[功能介绍](#功能特性) · [快速开始](#快速开始) · [部署指南](#生产环境部署) · [API 文档](My-Blog-Go/API.md)
...
```bash
git clone https://github.com/monkey-papa/NEBULA-BLOG.git
cd NEBULA-BLOG
...
| 地址                            | 说明         |
| ------------------------------- | ------------ |
| `http://localhost:5173`         | 博客前台首页 |
| `http://localhost:5173/admin`   | 后台管理面板 |
| `http://localhost:8082/api/...` | API 接口     |
...
docker build -t nebula-blog-backend .
