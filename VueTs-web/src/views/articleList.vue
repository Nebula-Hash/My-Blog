      ...
      <template v-else>
        <div class="recent-post-item shadow-box" v-for="(article, index) in articleList" :key="index" :class="{
          ...
          <div class="recent-post-item-image" :class="{
            ...
            <el-image class="custom-el-image" @load="allLoad" :lazy="activeIcon" :src="article.articleCover"
              fit="cover">
              <!-- 懒加载图片 -->
              ...
              <template v-slot:error>
                <div class="image-slot myCenter">
                  <img class="error-img img" :class="{ 'error-img__active': !activeIcon }"
                    src="../assets/images/errorBG.jpg" alt="图片加载失败" />
                  <div class="error-text">
                    <div class="error-text-content">图片遗失在外太空咯~┮﹏┭</div>
                  </div>
                </div>
              </template>
            </el-image>
