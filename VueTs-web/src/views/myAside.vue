<template>
  <div class="aside-container">
    ...
    <div class="aside-card-content shadow-box">
      <div class="author-box myCenter">
        ...
        <div class="author-img">
          <img src="/images/nebula-hash.jpg" alt="站点封面" />
        </div>
      </div>
      <div class="image-dot"></div>
      <div class="web-name">Nebula-Hash</div>
      <div class="web-info">
      ...
      <a class="collection-btn myCenter" @click="showTip()">
        <el-icon size="20" class="icon-loading">
          <Loading />
        </el-icon>
        微言圈
      </a>
      <div class="aside-link-box a-svg">
        <a @click="copy(2)" href="javascript:;" title="联系微信">
          <SvgIcon icon="WeChatIcon" size="16px" />
        </a>
        <a @click="copy(1)" href="javascript:;" title="联系QQ">
          <SvgIcon icon="QQIcon" size="16px" />
        </a>
        <a href="https://www.bilibili.com" target="_blank" title="哔哩哔哩">
          <SvgIcon icon="BiLiBiLiIcon" size="16px" />
        </a>
        <a href="https://www.xiaohongshu.com" target="_blank" title="小红书">
          <SvgIcon icon="XiaoHongShuIcon" size="16px" />
        </a>
        <a href="https://www.douyin.com" target="_blank" title="抖音">
          <SvgIcon icon="DouYinIcon" size="16px" />
        </a>
        <a href="https://www.zhihu.com" target="_blank" title="知乎">
          <SvgIcon icon="ZhiHuIcon" size="16px" />
        </a>
        <a href="https://y.qq.com" target="_blank" title="QQ音乐">
          <SvgIcon icon="QQMusicIcon" size="16px" />
        </a>
      </div>
    </div>
    <!-- 天气时间 -->
    <div v-if="route.path !== '/article'" class="card-widget card-widget-weather" data-aos="fade-up">
        ...
        <div class="weather-content-inner">
          ...
          <div class="mk-Today_weather myBetween">
            <div class="left">
              <div class="weather-icon">
                <img v-if="weather?.type" class="iconfont" :src="getWeatherIconUrl(weather?.type)" />
              </div>
              <div class="temp">
                <div class="number">
          ...
          <div class="mk-week_weather">
            <div class="tomorrow">
              ...
              <div class="icon">
                <img v-if="tomWeather?.type" class="iconfont" :src="getWeatherIconUrl(tomWeather?.type)" />
              </div>
              <div class="temp">
            ...
            <div class="afterTomorrow">
              ...
              <div class="icon">
                <img v-if="afterTomWeather?.type" class="iconfont" :src="getWeatherIconUrl(afterTomWeather?.type)" />
              </div>
              <div class="temp">
            ...
            <div class="afterAfterTomWeather">
              ...
              <div class="icon">
                <img v-if="afterAfterTomWeather?.type" class="iconfont"
    ...
    <!-- 最近更新 -->
    <div v-if="!$common.isEmpty(latelyArticles)" class="card-widget card-widget-recent" data-aos="fade-up">
      <div class="card-content-title">
      ...
      <div v-for="(article, index) in latelyArticles" :key="index"
        ...
        <div class="aside-post-date">
          <el-icon :size="12" color="var(--red1)">
            <Calendar />
          </el-icon>
    ...
    <!-- 流浪者 -->
    <div class="card-widget card-widget-wanderer" data-aos="fade-up"
      ...
      <div class="wanderer-scroll">
        <vue3-seamless-scroll v-if="users && users.length > 0" :key="users.length" :list="users" :step="1"
          :hover="true">
          <ul class="wanderer-list">
            <div v-for="(item, i) in users" class="wanderer-item" :key="i">
              <div class="wanderer-item-left">
                <el-avatar class="wanderer-avatar" :size="36" :src="item.avatar ? item.avatar : webInfo.avatar" />
    ...
    <!-- 分类 -->
    <div class="card-widget card-widget-sort" data-aos="fade-up">
      <div class="card-content-title">
        <el-icon class="card-content-icon">
          <Menu />
        </el-icon>
        <span>文章分类</span>
      </div>
    ...
    <!-- 书虫 -->
    <div v-if="!$common.isEmpty(labelInfo)" class="card-widget card-widget-tag" data-aos="fade-up">
      <div class="card-content-title">
        <i class="fa iconfont icon-shuchongicon card-content-icon"></i>
        <span>书虫</span>
      </div>
      <div class="card-tag-cloud">
        <a class="item" v-for="(label, index) in labelInfo" :key="index"
    ...
    <template v-if="route.path !== '/article'">
      <div v-for="(sort, index) in fastSeeInfo" @click="selectSort(sort)" :key="index"
        class="card-widget card-widget-preview" data-aos="fade-up">
        <div class="card-content-title">
          <el-icon class="card-content-icon">
            <Histogram />
          </el-icon>
    ...
    <!-- 加入我们 -->
    <el-dialog class="custom-my-dialog mk-join__dialog" title="加入组织" v-model="showTissueDialog" width="25%"
    ...
    .aside-link-box {
      ...
      a {
        ...
        &:hover {
          ...
          :deep(.svg-icon) {
            opacity: 1;
            filter: brightness(0.4) saturate(1.3) contrast(1.2) drop-shadow(0 0 2px rgba(0, 0, 0, 0.2));
          }
        }
      }
    }
