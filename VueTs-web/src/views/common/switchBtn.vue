<template>
  <div>
    ...
    <button>
      ...
      <img class="✈️" src="../../assets/images/switch-feiji.png" />
      <img class="🐻" src="../../assets/images/switch-guaishou.png" />
      <div class="⭕️"></div>
      <div class="💭">
        <div class="☁️"></div>
        <div class="☁️"></div>
...
button::after {
  ...
  inset: 0;
  box-shadow:
    calc(var(--width) * 0) calc(var(--width) * -0.025) calc(var(--width) * 0.025) 0 #17191c26 inset,
...
button .🌞 {
  ...
  box-shadow:
    0 5px 5px 0 rgb(215, 222, 234) inset,
