<template>
  <div class="card-container" v-if="!$common.isEmpty(props.resourcePathList)">
    <div v-for="(resourcePath, index) in props.resourcePathList" :key="index" class="card-item shadow-box"
      data-aos="fade-up" @click="clickResourcePath(resourcePath)">
      <div class="card-image">
        <el-image class="custom-el-image" lazy :src="resourcePath.cover" fit="cover">
          <template v-slot:error>
            <div class="image-slot myCenter">
              <div class="error-text">
                <div class="error-text-content">图片遗失在外太空咯~</div>
              </div>
            </div>
          </template>
        </el-image>
      ...
      <div class="card-body">
        ...
        <div class="card-time">
          <el-icon size="14" class="icon-loading">
            <Loading />
          </el-icon>
