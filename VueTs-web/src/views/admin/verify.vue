<template>
  <div class="content transformCenter">
    <div class="left">
      <img src="../../assets/images/verify2.png" class="people p-animation" alt="people" />
      <img src="../../assets/images/verify1.png" class="sphere s-animation" alt="sphere" />
    </div>
    <div class="right">
      <div class="top">
        <div class="top-item">
      ...
      <div class="form-wrapper transformCenter">
        ...
        <proButton :info="'提交'" @click="login()" :before="$constant?.before_color_1"
