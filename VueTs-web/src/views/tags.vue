      ...
      <div class="layout">
        <div id="tag">
          ...
          <div id="catalog-bar">
            ...
            <div id="catalog-list">
              <div v-for="(label, i) in labelInfo" :key="i" @click="toggleLabel(label)" class="catalog-list-item"
                :class="{
            ...
            <div class="article-sort-item shadow-box" v-for="(item, i) in articles" :key="i">
              <a @click="
                ...
                <el-image class="img" lazy :src="item.articleCover">
                  ...
                  <template v-slot:placeholder>
                    <div>
                      <div>
                        <img class="img-loading" src="../assets/images/lazy.gif" />
                      </div>
                    </div>
                  </template>
                  <!-- 错误图片 -->
                  <template v-slot:error>
                    <div class="image-slot myCenter">
                      <img class="error-img" src="../assets/images/errorBG.jpg" />
              ...
              <div class="article-sort-item-info">
                ...
                <a href="javascript:;" @click="
                  ...
                  " class="article-sort-item-title">{{ item.articleTitle }}<sup class="article-sort-item-index">{{ i +
                    1 }}</sup></a>
          ...
          <div class="pagination">
            <el-pagination background layout="prev, pager, next" :current-page="pagination.current"
