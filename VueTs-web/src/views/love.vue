  ...
  <div class="love-container">
    ...
    <div class="bg-wrap my-animation-slide-top">
      ...
      <div class="love-wrap transformCenter mySpaceAround">
        ...
        <div>
          <img class="love-img" src="../assets/images/heart.png" alt="心心" />
        </div>
        <div>
    ...
    <div>
      ...
      <div class="card-wrap-wrap">
        ...
        <div class="card-container">
          <div v-show="card === 1 && !$common.isEmpty(treeHoleList)">
            <treeHole :treeHoleList="treeHoleList" :avatar="webInfo.avatar" @launch="launch"
          ...
          <div v-show="card === 2 && !$common.isEmpty(photoTitleList)">
            ...
            <div class="photo-title-warp" v-if="!$common.isEmpty(photoTitleList)">
              ...
              <div class="article-info-news" @click="addPhoto"
        ...
        <div v-show="card === 4">
          <div class="family-container" v-show="!$common.isEmpty(randomFamily)">
            <div v-for="(item, index) in randomFamily" :key="index" @click="changeFamily(item)">
              <div class="family-wrap" :style="{
                ...
                <div>
                  <img class="family-img" src="../assets/images/heart.png" alt="心心" />
                </div>
                <div class="family-avatar-wrap">
          ...
          <div class="family-bottom-wrap">
            <div v-show="!$common.isEmpty(randomFamily) && randomFamily.length > 5" class="family-bottom"
      ...
      <!-- 入住 -->
      <el-dialog class="custom-my-dialog love-dialog" title="入住表白墙" v-model="loveDialogVisible" width="50%"
        :append-to-body="true" destroy-on-close center>
        <div>
          <div class="form-main">
            <img class="love-dialog-img" src="../assets/images/friend_chain_bg.jpg" />
                  ...
                  <div class="user-content">
                    <div class="love-dialog-form-item">
                      ...
                      <div class="form-input-wrap">
                        ...
                        <div class="form-button-wrap">
                          <proButton :info="'上传背景'" @click="openPicture('bgCover')" :before="$constant.before_color_1"
                    ...
                    <div class="love-dialog-form-item">
                      ...
                      <div class="form-input-wrap">
                        ...
                        <div class="form-button-wrap">
                          <proButton :info="'上传头像'" @click="openPicture('manCover')" :before="$constant.before_color_1"
                            :after="$constant.after_color_1" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="love-dialog-form-item">
                      ...
                      <div>
                        <el-date-picker v-model="userLove.timing" value-format="YYYY-MM-DD HH:mm:ss"
                          format="YYYY-MM-DD HH:mm:ss" type="datetime" placeholder="选择计时时间" />
                      </div>
                    </div>
                    <div class="love-dialog-form-item">
                    ...
                    <div class="love-dialog-form-item">
                      ...
                      <div>
                        <el-date-picker v-model="userLove.countdownTime" value-format="YYYY-MM-DD HH:mm:ss"
                          format="YYYY-MM-DD HH:mm:ss" type="datetime" placeholder="选择倒计时时间" />
                      </div>
                    </div>
                    <div class="love-dialog-form-item">
                      <div class="form-title">告白信&nbsp;&nbsp;</div>
                      <div>
                        <el-input type="textarea" show-word-limit maxlength="1000" v-model="userLove.familyInfo" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="myCenter submit-button-wrap">
                  <proButton :info="'提交'" @click.stop="submitLove()" :before="$constant.before_color_1"
                    :after="$constant.after_color_1" />
                </div>
              </div>
              <div class="love-dialog-footer">
                <img src="../assets/images/letter-3.jpg" />
              </div>
      ...
      <el-dialog class="custom-my-dialog" title="图片" v-model="addPictureDialog" width="25%" :append-to-body="true"
        destroy-on-close center>
        <div>
          <uploadPicture :ResourceType="ResourceType" @addPicture="addPicture" :maxSize="10" :maxNumber="1" />
        </div>
      </el-dialog>
      <el-dialog class="custom-my-dialog add-resource-path-dialog" title="添加图片" v-model="addResourcePathDialog"
        width="50%" :before-close="clearDialog" :append-to-body="true" center>
        <div class="add-resource-path-content">
          <div class="add-resource-path-form">
            ...
            <el-select @blur="closeOptions" ref="fuzzyCommentType" v-model="resourcePath.classify" filterable
              allow-create default-first-option placeholder="请选择分类">
              <el-option v-for="item in photoTitleList" :key="item.classify" :label="item.classify"
                :value="item.classify" />
            </el-select>
            ...
            <div class="add-resource-path-form-cover-input">
              ...
              <div class="add-resource-path-form-cover-button-wrap">
                <proButton :info="'上传封面'" @click="addResourcePathCover()" :before="$constant.before_color_1"
                  :after="$constant.after_color_1" />
              </div>
            </div>
          </div>
          <div class="add-resource-path-button-wrap myCenter">
            <proButton :info="'提交'" @click="addResourcePath()" :before="$constant.before_color_1"
              :after="$constant.after_color_1" />
          </div>
        </div>
      </el-dialog>
...
.love-container {
  background-image:
    linear-gradient(to right, var(--black12) 1px, var(--background) 1px),
