<template>
  <div class="friend-container">
    <!-- 背景图片 -->
    <div style="animation: header-effect 2s" :style="{ background: `${changeBgState}` }"
    ...
    <div class="friend-wrap">
      <div class="friend-main">
        ...
        <div @click="clickLetter()" class="form-wrap">
          <!-- 信封上面 -->
          <img class="before-img" src="../assets/images/letter-4.jpg" />
          <!-- 信 -->
          <div class="envelope" style="animation: hideToShow 2s">
            <div class="form-main shadow-box">
              <img class="envelope-img" src="../assets/images/friend_chain_bg.jpg" />
              <div class="envelope-content">
                ...
                <div class="envelope-content-form">
                  ...
                  <div class="submit-button-wrap myCenter">
                    <proButton :info="'提交'" @click.stop="submitFriend()" :before="$constant.before_color_1"
                      :after="$constant.after_color_1" />
                  </div>
                </div>
                <div class="envelope-footer">
                  <img class="envelope-footer-img" src="../assets/images/letter-3.jpg" />
                </div>
                <p class="envelope-footer-text">欢迎交换友链</p>
              </div>
            </div>
          </div>
          <img class="after-img" src="../assets/images/letter-2.jpg" />
        </div>
        <hr />
        <h2 class="friend-thanks-title"><i class="fa fa-address-card"></i>特别鸣谢</h2>
        <card class="recommendFriend" :resourcePathList="thanksFriendList" @clickResourcePath="clickFriend" />
