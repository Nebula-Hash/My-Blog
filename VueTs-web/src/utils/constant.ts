...
const constant: ConstantConfig = {
  ...
  webURL: import.meta.env.VITE_WEB_URL || "http://localhost:8082",
  ...
  // 站点 & 联系方式配置
  siteName: "Nebula-Blog", // 站点名称
  bossEmail: "2461287820@qq.com", // 博主邮箱（用于审核通知等）
  qqNumber: "2461287820", // 博主QQ号
  wechatId: "R19330685194", // 博主微信号
  // 加密密钥
  cryptojs_key: "Nebula-blog-20260406",
  // 默认图片配置
  defaultAvatar: "https://oss.nebula-hash.com/default/administrator_avatar.jpg", // 默认头像地址
  defaultBackground: "https://oss.nebula-hash.com/default/background.jpg", // 默认背景图地址
  // 外部服务URL
